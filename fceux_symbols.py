...
if __name__ == "__main__":
    label_to_nl("porklike.labels.txt", "porklike.nes.ram.nl", 0x0000, 0x7FF)
    label_to_nl("porklike.labels.txt", "porklike.nes.0.nl", 0x8000, 0xBFFF)
    label_to_nl("porklike.labels.txt", "porklike.nes.1.nl", 0xC000, 0xFFFF)
